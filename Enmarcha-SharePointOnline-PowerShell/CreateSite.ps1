...
Process {
    ...
    try {
        Add-Type -Path "C:\Archivos de programa\Common Files\microsoft shared\Web Server Extensions\16\ISAPI\Microsoft.SharePoint.Client.dll"
    }
    catch {}
    try {
        Add-Type -Path "C:\Archivos de programa\Common Files\microsoft shared\Web Server Extensions\16\ISAPI\Microsoft.SharePoint.Client.Runtime.dll"
    }
    catch {}
    try {
        Add-Type -Path "C:\Archivos de programa\Common Files\microsoft shared\Web Server Extensions\16\ISAPI\Microsoft.SharePoint.Client.Publishing.dll"
    }
    catch {}
    try {
        Add-Type -Path "C:\Archivos de programa\Common Files\microsoft shared\Web Server Extensions\16\ISAPI\Microsoft.SharePoint.Client.Taxonomy.dll"
    }
    catch {}
